...
var Thermostat = module.exports = function Thermostat() {
  ...
  this.commands = ['name', 'ambientTemperatureF', 'ambientTemperatureC', 
  								 'targetTemperatureF', 'targetTemperatureC', 'setTargetTemperatureF', 'setTargetTemperatureC'];
};
...
Thermostat.prototype.setTargetTemperatureF = function(value) {
  this.connection.write("target_temperature_f", value);
};
...
Thermostat.prototype.setTargetTemperatureC = function(value) {
  this.connection.write("target_temperature_c", value);
};
